...
class AreasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create area" do
    assert_difference('Area.count') do
      post areas_url, params: { area: { coordenadoria_id: @area.coordenadoria_id, descricao: @area.descricao } }
    end
  ...
  test "should update area" do
    patch area_url(@area), params: { area: { coordenadoria_id: @area.coordenadoria_id, descricao: @area.descricao } }
